...
- **[MasrCart](https://masrcart.com)** — A multi-vendor **e-commerce marketplace** SaaS for Egyptian sellers (NestJS 11 · Prisma · PostgreSQL 16 · Next.js 15): 215+ endpoints, vendor subscriptions & payout ledgers, localized payments (Cash on Delivery, InstaPay, Vodafone Cash), SSE + Redis real-time, and BullMQ transactional-email flows.
...
![BullMQ](https://img.shields.io/badge/BullMQ-EC4A3B?style=flat-square&logo=redis&logoColor=white)
